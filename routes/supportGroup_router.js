...
supportGroupRouter.patch('/users/supportGroup', checkAuth, hasPermission('update_supportGroup'), updateGroup);
supportGroupRouter.delete('/users/supportGroup/:id', checkAuth, hasPermission('delete_supportGroup'), deleteGroup);
supportGroupRouter.post('/users/supportGroup', checkAuth, hasPermission('join_supportGroup'), joinGroup);
supportGroupRouter.post('/users/supportGroup', checkAuth, hasPermission('leave_supportGroup'), leaveGroup);
